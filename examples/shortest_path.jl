...
for (src, dst) in edges
    ...
    # We currently put the cost variable on the vertex at the tail of the edge, until variables on the edges are implemented.
...
for edge in edges
    if Graphs.has_edge(sol, edge)
        ...
        # Is there some way to verify the corectness of the solution (in particular the costs)?
